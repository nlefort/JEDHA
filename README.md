...
| Vente magasins Machine Learning | *Créer un modèle d'apprentissage automatique capable d'estimer les ventes hebdomadaires de supermarchés*, *Identifier les facteurs influençant les ventes en magasins* |
| Challenge taux de conversion | *Créer un modèle d'apprentissage automatique permettant de prédire les souscriptions à une newsletter* |
| Best place to be | *Créer un algorithme permettant d'identifier les zones chaudes de demandes de chauffeurs*, *Visualiser les résulats sur un tableau de bord* |
| Spam | *Créer un algorithme permettant de signaler automatiquement les spams* |
| Déploiement | *Analyser un jeu de données et déterminer un seuil minimal entre deux locations de véhicules*, *créer un algorthme d'apprentissage automatique permettant de prédire le coût de location de son véhicule en fonction de ses caaractéristiques*, *Visualiser les résultats sur un tableau de bord* |

## Contact

Nadège Lefort, <lefortnad@yahoo.fr>
